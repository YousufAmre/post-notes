...
/* harmony import */ var _my_notes_my_notes_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./my-notes/my-notes.component */ "./src/app/my-notes/my-notes.component.ts");
/* harmony import */ var _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/platform-browser/animations */ "./node_modules/@angular/platform-browser/fesm2015/animations.js");
/* harmony import */ var _my_notes_mynotes_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./my-notes/mynotes.service */ "./src/app/my-notes/mynotes.service.ts");
...
AppModule = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _my_notes_my_notes_component__WEBPACK_IMPORTED_MODULE_6__["MyNotesComponent"]
        ],
        imports: [
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forRoot([
                { path: '', component: _my_notes_my_notes_component__WEBPACK_IMPORTED_MODULE_6__["MyNotesComponent"] }
            ]),
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _mynotes_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mynotes.service */ "./src/app/my-notes/mynotes.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let MyNotesComponent = class MyNotesComponent {
    constructor(_mynotesService, datePipe) {
    ...
    getNotes() {
        this._mynotesService.getNotes().subscribe(response => {
            this.notes = response;
        }, responseError => {
            this.notes = null;
    ...
    createNote(note) {
        this._mynotesService.postNote(note).subscribe(response => {
            if (response != null) {
                this.isCreated = true;
            }
            else {
...
MyNotesComponent.ctorParameters = () => [
...
MyNotesComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./my-notes.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/my-notes/my-notes.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./my-notes.component.css */ "./src/app/my-notes/my-notes.component.css")).default]
    }),
    __metadata("design:paramtypes", [_mynotes_service__WEBPACK_IMPORTED_MODULE_2__["MynotesService"], _angular_common__WEBPACK_IMPORTED_MODULE_0__["DatePipe"]])
], MyNotesComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MynotesService", function() { return MynotesService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let MynotesService = class MynotesService {
    constructor(http) {
        this.http = http;
    }
    getNotes() {
...
MynotesService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] }
];
MynotesService = __decorate([
...
module.exports = __webpack_require__(/*! C:\Users\SONY\source\repos\PostNotes\PostNotes\ClientApp\src\main.ts */"./src/main.ts");
